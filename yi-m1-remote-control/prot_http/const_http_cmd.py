...
class YiHttpCmdId(str, Enum):
    ...
    # Video format/mode setters found in firmware strings (RCVideoFormatSet, RCVASwitchSet,
    # RCEisSwitchSet, RCVANoiseReduceSet) were tried and all return HTTP 404 - not reachable
    # through this API despite the handler code existing in the firmware.
